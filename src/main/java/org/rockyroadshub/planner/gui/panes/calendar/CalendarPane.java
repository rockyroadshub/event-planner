...
import org.rockyroadshub.planner.gui.core.DLabel;
...
public final class CalendarPane extends AbstractPane {
    ...
    private final MToolBar  buttonsToolBar = new MToolBar();
    ...
    private void initButtons() {
        buttonsToolBar.addButtons(buttons, action);
    }
